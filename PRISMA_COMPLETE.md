...
| # | Bảng | Mục đích | Records sau seed |
|---|------|----------|------------------|
| 1 | **users** | Người dùng (User + Admin) | 3 |
| 2 | **topics** | Chủ đề từ vựng | 5 |
| 3 | **words** | Từ vựng tiếng Anh | 20 |
| 4 | **examples** | Câu ví dụ | 20+ |
| 5 | **favorites** | Từ yêu thích | 3 |
| 6 | **learning_sessions** | Phiên học tập | 1 |
| 7 | **learning_results** | Kết quả từng từ | 5 |
| 8 | **learning_progress** | Tiến độ tổng thể | 5 |
...
- `WordLevel`: beginner, intermediate, advanced
- `LearningStatus`: forgotten, uncertain, remembered, mastered
...
- ✅ CASCADE DELETE cho tất cả foreign keys
...
**Mọi thứ đã được setup chi tiết và document đầy đủ!** 🚀
